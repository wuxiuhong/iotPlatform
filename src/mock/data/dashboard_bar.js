    ...
    "components" : [
        {
            ...
            "template" : {
                ...
                "template" : {
                    "dependent" : [],
                    "templateHtml" : "<div class=\"main\"> <div class=\"leftdiv\"><svg id=\"svgCircleTutorial\" height=\"100%\" width=\"190\" xmlns=\"http://www.w3.org/2000/svg\"></svg></div> <div class=\"rightdiv\"> <div class=\"bottom-row\"> <div style=\"color:#04c1b0;\"><img src=\"./static/images/14.png\"/>&nbsp;&nbsp;机床信息</div> <div><span>设备编号</span><span >22323423</span></div> <div><span>设备型号</span><span>快捷设备DEPO SPEED</span></div> <div><span>类别</span><span>立式</span></div> <div><span>入厂日期</span><span>2001/01/05</span></div> <div><span>年限</span><span>14.2</span></div> </div> <div class=\"bottom-row\"> <div><span>机床状态</span><span style=\"color:#09a4d5;\" id=\"OPmtate\">{{OPmtate}}&nbsp;&nbsp;<svg id=\"svgCircleTutorial\" height=\"20\" width=\"20\" xmlns=\"http://www.w3.org/2000/svg\"></svg></span></div> <div><span>网络状态</span><span style=\"color:#7ed651;\">在线&nbsp;&nbsp;<svg id=\"svgCircleTutorial\" height=\"20\" width=\"20\" xmlns=\"http://www.w3.org/2000/svg\"></svg></span></div> <div><span>加工件数</span><span id=\"workcount\">{{workcount}}</span></div> <div><span>开机时间</span><span id=\"poweronTime\">{{poweronTime}}h</span></div> <div><span>循环时间</span><span id=\"cycletime\">{{cycletime}}h</span></div> <div><span>运行时间</span><span id=\"operatingTime\">{{operatingTime}}m</span></div> </div> </div> </div>",
                    "templateCss" : ".main{ width:100%; height: 100px; background-color:#262d45; color:rgba(255,255,255,0.7); font-size:14px; overflow: auto; } .leftdiv{ float:left; width:190px; height:98px; } .rightdiv{ float:left; width:calc(100% - 190px); height:calc(100% - 15px); padding-top:15px; } .bottom-row{ height:35px; line-height: 35px; float:left; width:100%; } .bottom-row div{ float:left; width:16%; color:#ededef; overflow: hidden; text-overflow:ellipsis; white-space: nowrap; } .bottom-row div span:first-child{ padding-right:10px; color:rgba(255,255,255,0.5); } .bottom-row div img{ vertical-align: middle; }",
                    "controllerScript" : {
                        "mounted" : "maxIot.getCount = 100 ",
                        "methods" : " return { onDataUpdated(data) { console.log(data, 'tste'); if (data.length) { data.forEach((item) => { this[item.k.l]= item.v; }); }}, onResize() { this.getCount = 0; }, increment() { this.getCount++; console.log('2222');this.$emit('child-event','hehe'); }, decrement() { this.getCount--; } }",
